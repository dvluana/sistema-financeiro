...
const variantConfig: Record<EmptyStateVariant, {
  ...
  entradas: {
    icon: TrendingUp,
    title: 'Sem entradas',
    description: 'Registre suas receitas como salário, freelance, vendas...',
  ...
  saidas: {
    icon: TrendingDown,
    title: 'Sem saídas',
    description: 'Registre suas despesas como contas, compras, assinaturas...',
  ...
  vencimentos: {
    ...
    description: 'Seus próximos vencimentos aparecerão aqui.',
    iconColor: 'text-azul',
    bgColor: 'bg-azul/10',
  },
}
