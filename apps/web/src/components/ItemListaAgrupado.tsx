        ...
        {expanded && (
          ...
          >
            <div className="pl-10 pr-2 pb-2 space-y-1">
              {/* Resumo */}
              {temFilhos && (
                <div className="flex justify-between items-center text-micro text-muted-foreground py-1 px-2 bg-muted/30 rounded">
                  <span>Total dos itens</span>
                  <span>{formatarMoeda(totalFilhos)}</span>
                </div>
              )}

              {diferenca !== 0 && temFilhos && (
                <div className={cn(
                  "flex justify-between items-center text-micro py-1 px-2 rounded",
              ...
              <button
                type="button"
                onClick={onAddFilho}
                className="w-full flex items-center justify-center gap-1 py-2 text-micro text-muted-foreground hover:text-foreground hover:bg-muted/50 rounded transition-colors"
              >
  ...
  return (
    <div className="flex items-center gap-2 py-1.5 px-2 rounded hover:bg-muted/30 transition-colors">
      ...
      >
        ...
        <span className={cn(
          'text-micro text-foreground shrink-0 ml-2',
          filho.concluido && mostrarConcluidosDiscretos && 'opacity-50'
        )}>
